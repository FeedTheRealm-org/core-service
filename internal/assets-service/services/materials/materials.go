...
func (ms *materialsService) GetMaterialsListByWorldAndType(worldID uuid.UUID, offset int, limit int) ([]*models.Material, error) {
	return ms.repository.GetMaterialsListByWorldAndType(worldID, offset, limit)
}
