...
<head>
  ...
  <style>
    ...
    @media only screen and (max-width:600px){
      ...
      .footer-box{padding:18px!important}
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation">
  <tr>
    <td align="center" style="padding:28px 12px;">
      ...
      <table class="container" width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;">

        <tr>
          <td align="center" style="padding:10px 18px;">
            <h1 class="headline" style="margin:0;font-weight:600;font-size:28px;color:#111827;">
              Feed The Realm - Activate your account
            </h1>
          </td>
        </tr>

        <tr>
          <td class="content" style="padding:18px 28px 28px 28px; text-align:center; color:#374151;">
            <p style="margin:0 0 10px 0; font-size:15px; line-height:1.5;">
              Your activation code for
              <strong style="background:#fff2b8;padding:0 4px;border-radius:2px;">Feed the Realm</strong>
							account is:
            </p>

            <div style="display:inline-block;margin-top:14px;padding:12px 18px;border-radius:8px;
                        background:#f3f4f6;font-weight:700;font-size:18px;letter-spacing:1px;color:#0f172a;">
              ` + verifyCode + `
            </div>
        ...
        <tr>
          <td align="center" style="padding:0 28px 28px 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                   style="background:#f3f6f9;border-radius:6px;overflow:hidden;">
              <tr>
                <td class="footer-box" style="padding:22px;text-align:center;">

                  <strong style="font-size:16px;color:#0f172a;">Feed the Realm</strong><br><br>

                  <div style="font-size:13px;color:#6b7280;line-height:1.5;">
                    Ciudad Autónoma de Buenos Aires, Argentina<br>
                    This email was sent automatically.<br>
                    You received this email because you attempted to register an account.
                  </div>
        ...
        <tr>
          <td style="text-align:center;font-size:12px;color:#9ca3af;padding:8px 0 28px 0;">
